(function($){
	...
	$.MediaBrowser = {
		...
		viewImage: function (){
			...
			src = URL;
			$('#image_previewer_content img').attr('src', src);
			$('#image_previewer').fadeIn('normal', function(){
				$('#image_previewer_content').show();
		...
		viewImageClose: function (){
			...
			$('#image_previewer_content').fadeOut('fast');
			$('#image_previewer').fadeOut('normal', function(){
