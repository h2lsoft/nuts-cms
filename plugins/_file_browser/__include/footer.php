...
function show_footer() {			// footer for html-page
	...
	$copyright_qx = "<SMALL><A class=\"title\" href=\"http://quixplorer.sourceforge.net\" target=\"_blank\">";
	$copyright_qx .= "QuiXplorer ".$GLOBALS["version"]."</A><SMALL>";
	$copyright_qx = '';
	echo "</center>$copyright_qx</BODY>\n</HTML>";
}
//------------------------------------------------------------------------------
?>