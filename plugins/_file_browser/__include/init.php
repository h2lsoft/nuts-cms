...
require "./__config/mimes.php";
require "./__include/fun_extra.php";
require "./__include/header.php";
require "./__include/footer.php";
require "./__include/error.php";
