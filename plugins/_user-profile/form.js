$('#former .bottom label').css('visibility', 'hidden');
...
$('#AvatarFacebook').click(function(){
    ...
    if((c=prompt(msg, "")))
    {
        uri = "http://graph.facebook.com/"+c+"/picture";
        $('#former #Avatar').val(uri);
        $('#former #avatar_image').attr('src', uri);
    }
});
...
function get_gravatar(email) {
    ...
    return 'http://www.gravatar.com/avatar/' + MD5(email) + '.jpg?s=60';
}
